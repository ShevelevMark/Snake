...
void* snake_make_context(unsigned row_size, unsigned col_size, int color_scheme[4], double start_time, double initial_speed, double level_up_speed_coeff, unsigned random_seed);
